...
<input type="hidden" id="currentLang" value="<?php echo $GLOBALS['qtm_lang'];?>" /> 
	<div class="h-g_template"></div>
...
<select name="sourate" id="change_sura" method="post" class="aya2" data-lang="<?php echo $GLOBALS['qtm_lang'];?>">
...
if(isset($_POST['cheikh_quran'])){
...

	{
		...
		echo '<option data-image="'.plugin_dir_url(__FILE__).'Allah.png" value="'. $sourate->nom_id . '"';
	if(isset($sura)){
		if($sura == $sourate->nom_id){ echo ' selected="selected">';}			
	}	
